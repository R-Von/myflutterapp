      ...
      home: Scaffold(
        ...
        body:new Column(
          ...
          children:<Widget>[
            ...
            new Text('Yellow',style: TextStyle(color:Colors.yellowAccent),),
            new Text('Green',style: TextStyle(color:Colors.greenAccent),),
            new Text('Blue',style: TextStyle(color:Colors.blueAccent),),
          ]
        )
      ),
    );
